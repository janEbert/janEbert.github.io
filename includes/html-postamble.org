		   ...
		   (concat "\
			...
			<div id=\"status-lines\">
				<a href=\""
				   relative-sitemap
				   "\
\" title=\"Sitemap\" class=\"hidden-link\" id=\"nethack-name\"></a>\
<a href=\"https://nethack.org\" title=\"The design reference\" \
class=\"hidden-link\" id=\"nethack-attributes\"></a>
				<br>
...
class=\"hidden-link\" id=\"back-to-top\">&lt;</a>\
...
(setq-local
 ...
 (let* ((sitemap-parent-dir
   ...
   (push (jan-website--construct-postamble relative-sitemap) postamble-alist)))
#+end_src
