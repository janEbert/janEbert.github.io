...
(let* ((parent-dir
	   ...
	   (relative-js-dir (file-relative-name
						 ...
						 parent-dir))
	   (favicon-parent-dir (locate-dominating-file parent-dir "favicon.svg"))
  ...
  (setq-local org-html-head
		...
		<link rel=\"icon\" href=\"" relative-favicon-dir "/favicon.svg\">
		<link rel=\"alternate icon\" href=\"" relative-favicon-dir "/favicon.png\">\
")))
